...
interface Trabalho {
  ...
  const [loading, setLoading] = useState(true);
    ...
    return (
      <main>
        <h1 className="mb-4 text-xl md:text-2xl">Cliente: {trabalho.cliente.nome}</h1>
        <div>
          ...
          <p><strong>Solução:</strong> {trabalho.solucao}</p>
          <p><strong>Data Criação:</strong> {trabalho.dataCriacao}</p>
          <p><strong>Garantia:</strong> {trabalho.garantia}</p>
          <p><strong>Status Ordem:</strong> {trabalho.statusOrdem}</p>
